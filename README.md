...
```
- Then, next I played with the time, which it shows on controlling the slow and fast motion on the sketch.
```ruby
time += 0.01; 
```
And again, fixed the full code again:
```ruby
let cols = 10;  
let rows = 10;  
let squareSize = 40; 
...
- Furthermore, processing on this workshop, I've learnt about repetition and even making the frames through p5.js, which I made a new improvement on both creativity and technical coding skills. I wished I could add more onto the sketch, but I again wanted to make it again simple but vibrant and crazy too. 
